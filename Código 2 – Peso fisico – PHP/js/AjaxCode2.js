...
function provinciaListOnChange2() {
var to=document.getElementById("advice2");
to.innerHTML="<img src='img/loading.gif' align='absmiddle'>";
    var provinciaList = document.getElementById("proceso_neg");
 
    var selectedprovincia = provinciaList.options[provinciaList.selectedIndex].value;
    var requestUrl;

     requestUrl = "xml_data_provider2.php" + "?filter=" + encodeURIComponent(selectedprovincia);
...
{	
    var localidadList = document.getElementById("subproceso");
