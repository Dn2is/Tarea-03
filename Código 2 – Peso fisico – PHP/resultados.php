...
<div class="login">	
			<div class="ribbon-wrapper h2 ribbon-red">
			 ...
			 <form id="frmLogin" method="POST" action="form.php" name="frmW" role="form" onSubmit="return validarForm(frmW);">
...
<?php
  ...
  { 
    ...
    $fuerza = $masa * 9.8;
    echo "El peso es de:" .$fuerza." N, presione atras para una cantidad nueva"; 
  }
?>
   ...
   <input type="submit" name="cmdRegistar" value="REGRESAR" style="margin-top:20px;" class="btn btn-primary" >
